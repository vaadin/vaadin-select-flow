...
public interface SelectDataView<T> extends DataView<T> {
    /**
     * Gets the item at the given index in the data set.
     *
     * @param index
    ...
    /**
     * Selects the item after the currently selected item in the data set.
     *
    ...
    /**
     * Selects the item before the currently selected item in the data set.
     *
     * @return the new selected item, or empty if the currently selected item is
     *         the first item in the data set.
     */
